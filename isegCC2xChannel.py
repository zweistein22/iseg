...
class PowerSupply(base.PowerSupply):
    ...
    def init(self):
        ...
        # begin below should turn off disallowed attribute for off state, but
        # it is not working
        ...
        # probably attribute is read in before by deviceworker -> todo: check
        # if time permitting.
        #end
    ...
    def rolisAlive(self):
        # this function is called once the crate is alive (= can accept
        # parameters)
        rol = []
